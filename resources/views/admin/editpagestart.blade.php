        ...
        <div class="col-md-8">
            <div class="card" style="margin-top: 50px;">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('editpagestart.update',['id'=>$pagestart->id])}}" method="Post" >
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" value="{{$pagestart->title}}" class="form-control" name="title" required >
                            </div>
                        </div>
